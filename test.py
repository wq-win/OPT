...
plt.plot(np.linspace(0, iter_num, iter_num), fit_var_list1, alpha=0.5, label="PSO")
...
plt.plot(np.linspace(0, iter_num, iter_num), fit_var_list2, alpha=0.5, label="DE")
